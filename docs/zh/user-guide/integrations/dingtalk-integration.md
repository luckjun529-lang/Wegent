...
Wegent 支持在聊天输入框里直接引用钉钉文档。系统会先通过后端 DWS 读取你同步后的文档树，再把选中的文档物化成 Markdown 引用发送给模型。

### 使用方式

1. 在聊天输入框点击 **钉钉文档** 按钮
2. 如果尚未授权，系统会打开钉钉设备码授权页
3. 完成授权后，Wegent 会自动同步你的 **我的文档** 和 **知识库**
4. 从树形列表中选择要引用的文档
...
- 每条消息最多可引用 10 篇钉钉文档
- 文档内容会在服务端转换为 Markdown 附件，执行器和 sandbox 不会持有钉钉凭证
