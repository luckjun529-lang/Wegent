...
| Git repository plugin publication                  | [plugin-repository-publication.md](plugin-repository-publication.md)         | Repository configuration, developer authorization, pinned refs, security scan, immutable releases             |
